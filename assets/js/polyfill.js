...
$(window).resize(function(){
    width = $(this).width();
    if (width <= 1024) {
        $("#blog-menu-btn").removeClass('am-icon-close');
        $("#blog-menu-btn").addClass('am-icon-navicon');
        $('.blog-aside-ctn').hide();
    } else {
        $("#blog-menu-btn").removeClass('am-icon-navicon');
        $("#blog-menu-btn").addClass('am-icon-close');
        $('.blog-aside-ctn').show();
    }
});
(function($) {
    ...
    $(document).ready(function (){
        $("#blog-menu-btn").click(function(){
            if ($(this).hasClass('am-icon-navicon')) {
                $(this).removeClass('am-icon-navicon');
                $(this).addClass('am-icon-close');
                $('.blog-aside-ctn').show();
            } else {
                $(this).removeClass('am-icon-close');
                $(this).addClass('am-icon-navicon');
                $('.blog-aside-ctn').hide();
            }
        });
    });
